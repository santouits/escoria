...
const ITEM = preload("res://globals/item.gd")
const EXIT = preload("res://globals/exit.gd")
const BACKGROUND = preload("res://addons/escoria/escoria_background.gd")
...
const COMPONENT = preload("res://globals/component.gd")

enum Type {Click, Trigger}